...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar">
            <a href="JobseekerDashboard.jsp">Go to Jobseeker Dashboard</a>
        ...
        <%
            ...
            Jobseeker jobseeker = dao3.getJobseekerById(id);
        %>


        <div class="container form-container">
            <h1 class="text-center"></h1>
            <form id="registrationForm" action="JobseekerUpdateServlet" method="post">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" value="<%=jobseeker.getLname()%>" name="lname" class="form-control" id="lname" placeholder="Enter Last Name">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="password" value="<%=jobseeker.getPassword()%>"  name="password" class="form-control" id="password" placeholder="Enter Password">
