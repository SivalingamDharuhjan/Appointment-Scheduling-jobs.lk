...
<html>
    ...
    <body>
        <header>
            <h1>Welcome to The Jobs.lk - Admin</h1>
        </header>
        ...
        <div class="flex-container reverse">
            <div class="navbar">
                <nav>
                    <ul>
                        ...
                        <li><a href="Multiuser.jsp">Log Out</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <section class="section" id="consultant-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <a href="CreateConsultant.jsp" style="text-decoration: none;"> Add Consultant</a> 
                        <br> <br>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                ...
                                <td><a href="EditConsultant.jsp?id=<%=d.getId()%>"
                                       class="btn btn-sm btn-primary" style="text-decoration: none;" >Edit</a> 

                                    <a
                                        href="DeleteConsultant.jsp?id=<%=d.getId()%>"
                                        class="btn btn-sm btn-danger" style="text-decoration: none;">Delete</a></td>
                            </tr>
                            <%
                                }
                            %>
            ...
            <section class="section" id="job-seeker-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        ...
                        <a href="CreateJobseeker.jsp" style="text-decoration: none;"> Add Jobseeker</a> 
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= jobseeker.getHighestqualification()%></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="DeleteJobseeker.jsp?id=<%= jobseeker.getId()%>"
                                           class="btn btn-sm btn-danger" style="text-decoration: none;">Delete</a>
                                    </td>
                                </tr>
                                <%
                                    } // End of loop
