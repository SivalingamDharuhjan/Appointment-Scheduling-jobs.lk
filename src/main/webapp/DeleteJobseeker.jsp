...
<html lang="en">
    <head>
        ...
        <title>Admin DashBoard | Delete Job Seeker</title>
    ...
    <body>
        ...
        <%
            ...
            Jobseeker d = dao3.getJobseekerById(id);
        %>

        <div class="container form-container">
            <h1 class="text-center"></h1>
            <form id="registrationForm" action="DeleteJobseekerServlet" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" value="<%=d.getPhoneNumber()%>" name="highestqualification" class="form-control" id="highestqualification" placeholder="Enter Highest Qualification">
