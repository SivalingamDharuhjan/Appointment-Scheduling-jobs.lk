...
<html lang="en">
    <head>
        ...
        <title>MultiUser | Consultant Signup Page</title>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a href="ConsultantSignIn.jsp">About Us</a>
        ...
        <button class="form-link-button" type="button" onclick="window.location.href = 'Multiuser.jsp';">Already have an Account?</button>
