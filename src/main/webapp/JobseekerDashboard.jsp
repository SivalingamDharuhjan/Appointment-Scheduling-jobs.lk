...
<html>
    ...
    <body>
        <header>
            ...
            <h1>Welcome to The Jobs.lk - Jobseeker</h1>
        </header>
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <table class="table">
                            ...
                            <%
                                JobSeekerDao dao2 = new JobSeekerDao(dbconnect.getConn());
                                List<Jobseeker> list2 = dao2.getAllJobseekers();
                                for (Jobseeker d : list2) {
                            %>
                            <tr>
                                <td><%=d.getFname()%></td>
                                <td><%=d.getLname()%></td>
                                <td><%=d.getEmail()%></td>
                                <td><%=d.getPassword()%></td>
                                <td><%=d.getHighestqualification()%></td>   
                                <td><%=d.getPhoneNumber()%></td>
                                                         
                                <td><a href="JobseekerEdit.jsp?id=<%=d.getId()%>"
