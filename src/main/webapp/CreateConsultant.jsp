...
<html lang="en">
    <head>
        ...
        <title>Admin DashBoard | Create Consultant</title>
    ...
    <body>
        ...
        <div class="container form-container">
            ...
            <form id="registrationForm" action="CreateConsultantServlet" method="post">
                <div class="row">
...
<script>
    ...
    function GetData() {
        ...
        if (validateForm()) {
            ...
            var successMessage = "Consultant details Creatw successfully.";
            var errorMessage = "Failed to Create onsultant details.";
            var isSuccess = true;
